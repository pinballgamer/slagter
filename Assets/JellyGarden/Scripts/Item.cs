...
//		print ("set striped");
	...
	IEnumerator DestroyCor (bool showScore = false, string anim_name = "", bool explEffect = false) {
		...
		//if (boost && currentType == ItemsTypes.PACKAGE)
		//{
		//    LevelManager.THIS.BoostPackage = 0;
		//    boost = false;
		//}
		//if (boost && currentType == ItemsTypes.BOMB)
		//{
		//    LevelManager.THIS.BoostColorfullBomb = 0;
		//    boost = false;
		//}
		//if (boost && (currentType == ItemsTypes.HORIZONTAL_STRIPPED || currentType == ItemsTypes.VERTICAL_STRIPPED))
		//{
